...
const TTSPlayer: SerializedComponent = {
  ...
  props: {
    className:
      'flex items-center gap-4 px-6 py-3 bg-blue-950 border border-blue-900 rounded-xl mb-8',
  ...
  children: [
    {
      ...
      props: {
        className:
          'flex items-center justify-center w-10 h-10 bg-blue-500 rounded-full text-white hover:bg-blue-400 transition-colors shrink-0',
          ...
          children: [
            {
              type: 'div',
              props: {
                className: 'w-0 h-1 bg-blue-400 rounded-full',
...
const pageTree: SerializedComponent = {
  ...
  children: [
      ...
      children: [
        {
          ...
          props: {
            className:
              'flex items-center gap-2 text-lg font-bold text-blue-400',
          },
          children: [HomeIcon, 'The Wally Wallington Wonder Archive'],
        },
        // Presence
        {
          type: 'div',
          ...
          children: [
              ...
              children: [
                {
                  ...
                  props: {
                    className:
                      'w-5 h-5 rounded-full bg-blue-500 border-2 border-neutral-950',
                  },
                  children: [],
                },
                {
                  ...
                  props: {
                    className:
                      'w-5 h-5 rounded-full bg-emerald-500 border-2 border-neutral-950',
                  },
                  children: [],
                },
              ],
            ...
            {
              type: 'span',
              props: { className: 'text-emerald-400 text-xs' },
              children: ['2 reading'],
            },
          ],
        },
          ...
          children: [
            {
              ...
              props: {
                className:
                  'text-blue-400 text-sm bg-blue-950 px-3 py-1 rounded',
                href: '/',
              },
              children: ['Home'],
            },
    ...
    // ── Main Content ──
    {
      ...
      children: [
        // Intro
        {
          ...
          props: {
            className:
              'text-lg text-neutral-300 border-l-4 border-blue-400 pl-4 mb-8',
            'data-esi-directive': 'translate',
          },
          children: [
                      ...
                      children: [
                        {
                          ...
                          props: {
                            ...
                            placeholder:
                              'Join the discussion... (ESI-moderated)',
                            rows: '3',
                          ...
                          children: [
                            {
                              ...
                              props: { className: 'text-xs text-neutral-600' },
                              children: [
                                'AI-moderated for quality and relevance',
                              ],
                            },
                            {
                              type: 'button',
                              props: {
                                className:
                                  'px-4 py-2 bg-blue-500 text-white rounded-lg text-sm font-semibold hover:bg-blue-400 transition-colors',
                                type: 'submit',
                              },
                              children: ['Post'],
                            },
    ...
    // ── Footer ──
    {
      ...
      props: {
        className:
          'text-center py-8 px-6 border-t border-neutral-800 max-w-3xl mx-auto',
      },
      children: [
        {
          type: 'p',
        ...
        },
        {
          ...
          props: {
            className:
              'flex items-center justify-center gap-2 mt-4 text-xs text-blue-600',
          },
          children: [
...
export const wallyWallingtonPage: PageSession = {
  ...
  data: {
    ...
    description:
      'Celebrating the remarkable engineering of Wally Wallington — the retired Michigan construction worker who moves 20-ton stones by hand using forgotten technology.',
  },
