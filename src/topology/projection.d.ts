...
export type FragmentObservabilityClass = 'critical' | 'visible' | 'supporting' | 'deferred' | 'opaque';
export type FragmentEffectClass = 'inert' | 'effectful' | 'unknown';
export type ProjectionProofLevel = 'none' | 'strong-html-css' | 'conservative-js';
...
export declare function createProjectionArtifactId(buildHash: string, nodes: readonly FragmentNode[]): string;
export declare function canonicalizeFeatureFlags(featureFlags: readonly string[]): string[];
export declare function normalizeRequestSignature(signature: RequestSignature): RequestSignature;
export declare function requestSignatureKey(signature: RequestSignature): string;
export declare function computeProjectionCacheKey(artifact: Pick<ProjectionArtifact, 'artifactId' | 'buildHash'>, signature: RequestSignature): string;
export declare function matchesRequestGuard(guard: RequestGuard, signature: RequestSignature): boolean;
