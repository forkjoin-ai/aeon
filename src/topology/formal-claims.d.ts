...
export declare function worthingtonWhipSavings(
  shards: number
): WorthingtonWhipResult;
export declare function speculativeTreeExpectedAccepted(
  alpha: number,
  depth: number
): SpeculativeTreeResult;
export declare function turbulentIdleFraction(
  stageCount: number,
  chunkCount: number
): TurbulentIdleResult;
export declare function frontierFill(
  frontierByLayer: readonly number[]
): FrontierFillResult;
export declare function pipelineOccupancy(
  stageCount: number,
  chunkCount: number
): PipelineOccupancyResult;
export declare function classifyPipelineRegime(
  stageCount: number,
  chunkCount: number
): PipelineRegime;
...
export declare function quantumDeficitIdentity(
  sqrtN: number
): QuantumDeficitResult;
export declare function protocolDeficits(
  streamCount: number
): ProtocolDeficitResult;
...
export declare function firstLawConserved(
  forkEnergy: number,
  foldWork: number,
  ventEnergy: number,
  tolerance?: number
