...
Void walking mechanizes Skyrms' insight.
...
We call this the **Skyrms equilibrium** in honor of Brian Skyrms, whose work on the evolution of the social contract (Skyrms, 1996, 2004) established that cooperative equilibria emerge from evolutionary dynamics without requiring rationality -- only iteration. The Skyrms equilibrium is the fixed point of the void gradient flow: the strategy profile where self-interested agents with perfect knowledge of the void boundary have no incentive to deviate. It differs from the Nash equilibrium precisely by the information content of the void boundary.
