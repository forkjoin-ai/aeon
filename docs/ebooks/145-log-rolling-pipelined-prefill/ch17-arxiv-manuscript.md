...
The two hundred seventy-one predictions (§19.8 through §19.61) now span one hundred thirty-one domains plus five deep type-level compositions. The deep compositions prove new structural results by chaining theorem conclusions: void tunnel correlation composes with Buleyean concentration to give ordered branch weights, semiotic deficit composes with context reduction to give bounded dialogue, and the universal convergence formula composes deficit monotonicity with collapse cost to give exact $N{-}1$ convergence. All two hundred seventy-one chain mechanized theorems (Lean4 sorry-free). All two hundred seventy-one name their falsification conditions.
