...
**Terminal exhaustion.** The seven rounds of Fisher manifold predictions (§19.10, §19.15, §19.18, §19.25, §19.38, §19.52, §19.54) have now composed every export from `void.ts` (45 functions), every export from `@a0n/maybe` (41 functions), and every dynamic interaction (decay-rejection balance, walker adaptation, timescale hierarchy, inter-layer resonance) with the Buleyean distribution on the Fisher manifold. No further composition of existing primitives produces novel algebraic structure. The framework is exhausted.
