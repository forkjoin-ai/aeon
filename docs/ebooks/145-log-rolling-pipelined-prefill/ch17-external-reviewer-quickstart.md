...
- If you need to inspect the formal boundary itself, start with [FORMAL_LEDGER.md](https://github.com/forkjoin-ai/gnosis/blob/main/FORMAL_LEDGER.md), then drop into [companion-tests/formal/THEOREM_LEDGER.md](./companion-tests/formal/THEOREM_LEDGER.md), [companion-tests/formal/README.md](./companion-tests/formal/README.md), and the compiler-specific note [companion-tests/formal/GNOSIS_COMPILER_BOUNDARY.md](./companion-tests/formal/GNOSIS_COMPILER_BOUNDARY.md).
