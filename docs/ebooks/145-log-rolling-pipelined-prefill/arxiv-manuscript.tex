...
mechanizes a conditional universal-floor theorem on explicitly witnessed
...
It guarantees that those which do will converge.  That is the
conclusion bait of \S\ref{conclusion}: the same theory that predicts
war prescribes its containment, and the prescription is constructive.
...
--- the mechanism is constructive.  Thirteen theorems, zero
\texttt{sorry}, composing sixty files of mechanized proof.
...
Thirteen theorems.  Every step machine-verified.
