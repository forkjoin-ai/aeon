...
ancestry), and \texttt{THM-INTERFERE-FRACTAL} (coarsening cannot make
...
\texttt{INTERFERE} that never collapses. Read through the present
...
\texttt{INTERFERE}. That makes CRDT recovery a practical example of the
