...
zero-deficit witness required by the conditional optimality-verification
theorem; therefore that theorem applies non-vacuously.
...
\subsubsection{15.2 The Buley Frontier}\label{buley-frontier}
...
\textbf{THM-BULEY-FRONTIER} (\texttt{BuleyFrontier.lean}) proves that for
...
directly, because THM-BULEY-FRONTIER provides the monotonicity and
...
\begin{figure}
\centering
\pandocbounded{\includesvg[keepaspectratio]{companion-tests/artifacts/ch17-buley-frontier-figure.svg}}
\caption{Figure 3.  The Buley Frontier: diversity vs waste across three
...
panels are instantiations of THM-BULEY-FRONTIER
(\texttt{BuleyFrontier.lean}): waste monotonically non-increasing in
