...
observer-independent in open systems. Reported deficits should therefore
be interpreted with explicit modeling assumptions and uncertainty
...
nonlinear winner/early-stop folds {[}9, 13{]}. This is therefore a
structural mapping, not an identity claim. Fluid dynamics provides
