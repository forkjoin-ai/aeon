...
\item
  ...
  idealized assumptions (uniform stage service time, zero inter-node communication cost; speedups halve when network cost equals compute cost --- see \S7 sensitivity analysis). The Wallington Rotation, expressed in layer 2's
