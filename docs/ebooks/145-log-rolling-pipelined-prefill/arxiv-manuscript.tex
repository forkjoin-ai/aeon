...
\textbf{The semiotic turn.} The companion \texttt{SemioticDeficit.lean}
...
irreducible Landauer cost.  \texttt{war\_as\_cumulative\_heat} proves
...
feedback loop.  It guarantees that those which do will converge.  The
deficit is real.  The heat is irreducible.  The trace converges.  The
fixed point exists.
